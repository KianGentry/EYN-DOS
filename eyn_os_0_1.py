...
menu = tk.Button(root, width = 5, height = 5, fg = 'black', text='Menu', command = help)
canvas1.create_window(150, 150, window=menu)

blank1 = tk.Label(root, width = 5, height = 2, text='')
blank1.pack(side = 'top')
    
shut_down = tk.Button(root, width = 8, height = 5, fg = 'black', text='Shut Down', command = shutdown)
shut_down.pack(side = 'bottom')

blank2 = tk.Label(root, width = 5, height = 1, text='')
blank2.pack(side = 'bottom')

test1 = tk.Button(root, width = 8, height = 5, fg = 'black', text='test')
test1.pack(side = 'top')
